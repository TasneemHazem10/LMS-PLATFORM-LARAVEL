    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li><a href="{{ route('courses.index') }}" class="hover:text-white">Programming</a></li>
                    <li><a href="{{ route('courses.index') }}" class="hover:text-white">Business</a></li>
                    <li><a href="{{ route('courses.index') }}" class="hover:text-white">Design</a></li>
                    <li><a href="{{ route('courses.index') }}" class="hover:text-white">Marketing</a></li>
                </ul>
            </div>
            <div>
